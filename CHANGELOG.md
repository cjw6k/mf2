...
- Compatible PHP-7.1
- Compatible PHP-7.0
- Complete set of passing tests from the Microformats test suite
- TEST: mf-test-suite/mixed/h-card/mixedproperties
...
- TEST: mf-test-suite/v1/includes/hcarditemref
- TEST: mf-test-suite/v1/includes/object
- TEST: mf-test-suite/v1/includes/hyperlink
- TEST: mf-test-suite/v1/hreview-aggregate/vevent
- TEST: mf-test-suite/v1/hreview-aggregate/hcard
